...
//    char AAP_VAL_MOD [97] = "Android Auto";    // "Android Open Automotive
//    Protocol"
...
#define USB_SETUP_HOST_TO_DEVICE                                               \
  0x00 // transfer direction - host to device transfer   = USB_DIR_OUT (Output
       // from host)
#define USB_SETUP_DEVICE_TO_HOST                                               \
  0x80 // transfer direction - device to host transfer   = USB_DIR_IN  (Input
       // to   host)
...
//#define USB_SETUP_RECIPIENT_INTERFACE           0x01    // recipient -
// interface
//#define USB_SETUP_RECIPIENT_ENDPOINT            0x02    // recipient -
// endpoint
